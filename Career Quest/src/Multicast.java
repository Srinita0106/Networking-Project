...
public class Multicast extends JFrame implements Writable {
    ...
    public Multicast() {
        setTitle("UDP Multicast");
        setSize(800, 600);
        setResizable(false);

        outputArea = new JTextArea();
        outputArea.setEditable(false);
        outputArea.setFont(new Font("Lora", Font.BOLD, 15));
    ...
    public static void main(String[] args) {
        Multicast app = new Multicast();
        app.setVisible(true);
        app.write("UDP Multicast");
        app.write("-".repeat(50));
    }
